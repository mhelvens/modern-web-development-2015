...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _exposeJQueryJquery2['default'])(document).ready(function () {
		...
		var message = (0, _exposeJQueryJquery2['default'])('#hello');

		var button = (0, _exposeJQueryJquery2['default'])('#hello-button');
		...
		var allOperations = _baconjs2['default'].mergeAll((0, _exposeJQueryJquery2['default'])('#minus-1').asEventStream('click').map(-1), (0, _exposeJQueryJquery2['default'])('#plus-1').asEventStream('click').map(+1), (0, _exposeJQueryJquery2['default'])('#plus-5').asEventStream('click').map(+5), (0, _exposeJQueryJquery2['default'])('#plus-10').asEventStream('click').map(+10));

		var counter = allOperations.scan(0, function (counter, value) {
		...
		counter.assign((0, _exposeJQueryJquery2['default'])('#counter'), 'text');
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js!./../node_modules/sass-loader/index.js!./index-1.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js!./../node_modules/sass-loader/index.js!./index-1.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body div.box {\n  border: solid 1px;\n  padding: 10px;\n  margin: 10px; }\n", ""]);
