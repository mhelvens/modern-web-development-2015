...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _exposeJQueryJquery2['default'])('document').ready(function () {
		...
		var mouseMoves = (0, _exposeJQueryJquery2['default'])(document).asEventStream('mousemove');
		var mouseUps = (0, _exposeJQueryJquery2['default'])(document).asEventStream('mouseup');

		var toCoords = function toCoords(e) {
			return [e.clientX - canvas.offset().left, e.clientY - canvas.offset().top];
		};

		var drawings = mouseDowns.flatMap(function () {
			return mouseMoves.map(toCoords).slidingWindow(2, 2).takeUntil(mouseUps);
		});

		drawings.onValue(function (_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js!./../node_modules/sass-loader/index.js!./index-2.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js!./../node_modules/sass-loader/index.js!./index-2.scss");
