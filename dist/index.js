...
/***/ function(module, exports, __webpack_require__) {
	...
	var _exposeJQueryJquery = __webpack_require__(198);

	var _exposeJQueryJquery2 = _interopRequireDefault(_exposeJQueryJquery);

	var _baconjs = __webpack_require__(200);
	...
	var fbRoot = new _firebase2['default']('//web-development-2014.firebaseio.com');
	var fbDrawings = fbRoot.child('drawings');
	var fbDrawingsStream = _baconjs2['default'].fromEventTarget(fbDrawings, 'child_added').map('.val');
	...
	(0, _exposeJQueryJquery2['default'])('document').ready(function () {
		...
		/* the canvas */
		var canvas = (0, _exposeJQueryJquery2['default'])('canvas');

		/* convenience function */
		var toCoords = function toCoords(e) {
			return [e.clientX - canvas.offset().left, e.clientY - canvas.offset().top];
		};

		/* capture drawings from the mouse */
		var mouseDowns = canvas.asEventStream('mousedown').doAction('.preventDefault');
		var mouseMoves = (0, _exposeJQueryJquery2['default'])(document).asEventStream('mousemove').doAction('.preventDefault');
		var mouseUps = (0, _exposeJQueryJquery2['default'])(document).asEventStream('mouseup').doAction('.preventDefault');
		var mouseDrawings = mouseDowns.flatMap(function () {
			return mouseMoves.map(toCoords).slidingWindow(2, 2).takeUntil(mouseUps);
		});

		/* capture drawings from the touchscreen */
		var touchDowns = canvas.asEventStream('touchstart').doAction('.preventDefault');
		var touchMoves = (0, _exposeJQueryJquery2['default'])(document).asEventStream('touchmove').doAction('.preventDefault');
		var touchUps = (0, _exposeJQueryJquery2['default'])(document).asEventStream('touchend').doAction('.preventDefault');
		var touchDrawings = touchDowns.flatMap(function () {
			return touchMoves.map('.originalEvent.touches.0').map(toCoords).slidingWindow(2, 2).takeUntil(touchUps);
		});

		/* publish mouse drawings to FireBase */
		mouseDrawings.merge(touchDrawings).onValue(function (segment) {
			fbDrawings.push({
				color: color,
				segments: [segment]
			});
		...
		fbDrawingsStream.onValue(function (_ref) {
			var _ref$segments = _slicedToArray(_ref.segments, 1);

			var _ref$segments$0 = _slicedToArray(_ref$segments[0], 2);

			var _ref$segments$0$0 = _slicedToArray(_ref$segments$0[0], 2);

			var x1 = _ref$segments$0$0[0];
			var y1 = _ref$segments$0$0[1];

			var _ref$segments$0$1 = _slicedToArray(_ref$segments$0[1], 2);

			var x2 = _ref$segments$0$1[0];
			var y2 = _ref$segments$0$1[1];
			var kleurtje = _ref.color;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body canvas {\n  position: absolute;\n  left: 10px;\n  top: 10px;\n  border: solid 2px black; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jQuery"] = __webpack_require__(199);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("function" !== "undefined" && __webpack_require__(202) !== null && __webpack_require__(203) != null) {
	  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return Bacon;
	  }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
